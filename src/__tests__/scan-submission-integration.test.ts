...
vi.mock("@/lib/config", () => ({
  ...
  // Plan 03 §4.1: ScanSubmissionSchema imports MAX_RELATED_CONTRACTS
  // from this module; mock must export it to keep the module graph load
  // path consistent with the real config.
